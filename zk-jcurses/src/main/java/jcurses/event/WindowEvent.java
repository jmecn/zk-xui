...
/**
 * Instances of this class are generated, if the status of a window is modified. for example, if an window is closed.
 */
public class WindowEvent extends Event {
     ...
     * @param type the type of the event, must be equal to one of four following constants: <br>
     ...
     *            <code>CLOSING</code> - the window has begun the process of closing
     */
