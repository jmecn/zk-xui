...
/**
 * This class is used for menus, that is a list, that prohibites items selection (only invocation with 'enter' is
 * possible). Also there is a possbility to add so called separator items, that are items with customited text (per
 * default empty) that cann't be invoked und are used only for optical purposes.
 */

import jcurses.system.InputChar;
import jcurses.util.Rectangle;

public class MenuList extends JCList<String> {
