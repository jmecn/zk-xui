...
public interface IScrollable {
    ...
    /**
     * The method returns the rectangle of the border, on which scrollbars are to be
     * paint
     *
    ...
    /**
     * The method returns the offset of the vertical scrollbar as part of the length
     * of the side of the border rectangle ( 0 < =value < 1.0 )
     */
    public float getVerticalScrollbarOffset();

    /**
     * The method returns the length of the vertical scrollbar as part of the length
     * of the side of the border rectangle ( 0 <value <= 1.0 )
     */
